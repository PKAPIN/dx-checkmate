...
st.set_page_config(page_title="DX-CheckMate [1차수]", page_icon=":material/fact_check:", layout="wide")

# 사용자별 고유 세션 ID 생성 (독립 체크포인트)
if "session_id" not in st.session_state:
    st.session_state.session_id = str(uuid.uuid4())[:8]

# =========================================================
# ⚙️ 각 앱별 설정값 (App 1, 2, 3에 맞춰 이 부분만 수정)
# =========================================================
APP_TITLE = "출석체크 1차수"
CURRENT_GID = "1678272994"  # 1차수: 1678272994 / 2차수: 1005009417 / 3차수: 508140271

# 3개 사이트의 실제 배포 URL 주소를 적어주세요.
URL_APP_1 = "https://your-app-1.streamlit.app"
URL_APP_2 = "https://your-app-2.streamlit.app"
URL_APP_3 = "https://your-app-3.streamlit.app"
# =========================================================
...
# 📌 상단 3개 사이트 상호 이동 네비게이션 바
st.markdown("### 🌐 차수별 전용 출석 사이트 이동")
nav_col1, nav_col2, nav_col3 = st.columns(3)
with nav_col1:
    st.link_button("📌 [1차수] 전용 사이트 바로가기", URL_APP_1, use_container_width=True)
with nav_col2:
    st.link_button("📌 [2차수] 전용 사이트 바로가기", URL_APP_2, use_container_width=True)
with nav_col3:
    st.link_button("📌 [3차수] 전용 사이트 바로가기", URL_APP_3, use_container_width=True)
...
with col_title:
    ...
    st.caption("독립된 개별 시스템으로 작동하며 상단 버튼으로 다른 차수 사이트를 새 탭에서 동시 관리할 수 있습니다.")
...
with col_guide:
    st.info(f"""
    **💡 사용 방법 가이드**
    1. 현재 화면은 **[{APP_TITLE}]** 전용 모듈입니다.
    2. 구글 시트의 **'출석체크_1'** 탭 데이터를 읽어와 자동 처리합니다.
    3. 다른 차수 출석을 동시에 진행하려면 상단 네비게이션 버튼을 눌러 **새 탭**에서 실행하세요.
    """)
...
try:
    ...
    st.write(f":material/list_alt: [{APP_TITLE}] 출석체크 대상자: **총 {len(target_df)}명**")
